# 🚀 Repositório C# - Estudos e Projetos

![C#](https://shields.io)
![.NET](https://shields.io)
![Visual Studio](https://shields.io)

Bem-vindo ao meu repositório de estudos e práticas em **C#**! Este espaço foi criado para consolidar meus aprendizados na linguagem e na plataforma .NET utilizando a IDE **Visual Studio**.
...
*   **Linguagem:** C#
*   **Plataforma:** .NET SDK / .NET Console Application
*   **IDE:** Microsoft Visual Studio

---

## ⚙️ Como Executar os Projetos no Visual Studio
